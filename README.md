...
A sophisticated **completely local** chatbot that can answer questions by querying databases and analyzing CSV data, with fine-tuning capabilities for improved performance. **No API keys required!**
